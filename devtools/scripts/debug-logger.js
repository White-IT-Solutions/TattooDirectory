...
Usage: node devtools/scripts/debug-logger.js <command> [options]
...
Examples:
  node devtools/scripts/debug-logger.js test
  node devtools/scripts/debug-logger.js export logs/debug-export.json
  LOG_LEVEL=debug node devtools/scripts/debug-logger.js test
`);
            break;
    }
}
