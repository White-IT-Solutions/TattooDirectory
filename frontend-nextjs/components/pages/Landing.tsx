          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/search" className="text-background/70 hover:text-background transition-colors">Search Artists</Link></li>
                <li><Link href="/faq" className="text-background/70 hover:text-background transition-colors">FAQ</Link></li>
                <li><Link href="/status" className="text-background/70 hover:text-background transition-colors">Status & Uptime</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/privacy" className="text-background/70 hover:text-background transition-colors">Data Privacy</Link></li>
