...
class AdvancedDevManager {
    ...
    printUsageInstructions() {
        ...
        console.log('   node dev-tools/advanced-dev-manager.js status    - Check status');
        console.log('   node dev-tools/advanced-dev-manager.js health     - Health check');
        console.log('   node dev-tools/advanced-dev-manager.js restart    - Restart services');
        console.log('   node dev-tools/advanced-dev-manager.js stop       - Stop services');
    }
}
...
Usage: node dev-tools/advanced-dev-manager.js <command>
...
Examples:
  node dev-tools/advanced-dev-manager.js start
  PROXY_PORT=9002 node dev-tools/advanced-dev-manager.js start
  node dev-tools/advanced-dev-manager.js health
`);
            break;
    }
