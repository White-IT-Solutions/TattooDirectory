...
Usage: node dev-tools/error-scenario-tester.js <command> [options]
...
Examples:
  ...
  node dev-tools/error-scenario-tester.js activate rate_limit_exceeded /v1/artists
  node dev-tools/error-scenario-tester.js test validation_error /v1/artists/search
  node dev-tools/error-scenario-tester.js test-suite
  node dev-tools/error-scenario-tester.js deactivate-all
`);
            break;
    }
}
