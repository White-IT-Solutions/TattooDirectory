...
create_log_group "/aws/lambda/tattoo-directory-api" "Main API Gateway handler for artist directory endpoints"
create_log_group "/aws/lambda/dynamodb-sync-handler" "DynamoDB to OpenSearch synchronization handler"
create_log_group "/aws/lambda/admin-notification-handler" "Admin notification processing handler"
create_log_group "/aws/lambda/system-alert-handler" "System alert processing handler"
create_log_group "/aws/lambda/takedown-handler" "Takedown request processing handler"

# API Gateway Log Groups
echo "Creating API Gateway log groups..."
create_log_group "/aws/apigateway/tattoo-directory-local" "API Gateway access and execution logs"
create_log_group "/aws/apigateway/tattoo-directory-local/access" "API Gateway access logs"
create_log_group "/aws/apigateway/tattoo-directory-local/execution" "API Gateway execution logs"
