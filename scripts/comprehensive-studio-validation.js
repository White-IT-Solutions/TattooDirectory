...
class ComprehensiveStudioValidator {
  ...
  async testArtistStudioRelationships() {
    try {
      const output = execSync('npm run manage-studio-relationships --workspace=scripts-studio-relationships --workspace=scripts-studio-relationships validate', { encoding: 'utf8' });
      const completed = output.includes('completed successfully');
