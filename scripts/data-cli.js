...
class DataCLI {
  ...
  showHelp(specificCommand = null) {
    ...
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-data clean`);
    console.log('');
    console.log(`  ${COLORS.dim}# Seed enhanced scenario with comprehensive data${COLORS.reset}`);
    console.log(`  npm run seed --workspace=scripts --workspace=scripts-scenario london-focused`);
    console.log('');
    console.log(`  ${COLORS.dim}# Studio-specific operations${COLORS.reset}`);
    console.log(`  npm run seed --workspace=scripts --workspace=scripts-studios --scenario studio-diverse`);
    console.log(`  npm run validate --workspace=scripts/documentation-analysis --workspace=scripts/documentation-analysis-studios relationships`);
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-studios --preserve-relationships`);
    ...
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-states       List available reset states`);
    console.log('');
  }
  ...
  showAvailableScenarios() {
    ...
    console.log(`${COLORS.bright}USAGE:${COLORS.reset}`);
    console.log(`  npm run seed --workspace=scripts --workspace=scripts-scenario <scenario-name>`);
    console.log('');
    console.log(`${COLORS.bright}EXAMPLES:${COLORS.reset}`);
    console.log(`  npm run seed --workspace=scripts --workspace=scripts-scenario minimal`);
    console.log(`  npm run seed --workspace=scripts --workspace=scripts-scenario london-artists`);
    console.log(`  npm run seed --workspace=scripts --workspace=scripts-scenario full-dataset`);
    console.log('');
  }
  ...
  showAvailableResetStates() {
    ...
    console.log(`${COLORS.bright}USAGE:${COLORS.reset}`);
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-data <state-name>`);
    console.log('');
    console.log(`${COLORS.bright}EXAMPLES:${COLORS.reset}`);
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-data clean`);
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-data search-ready`);
    console.log(`  npm run reset-data --workspace=scripts-data --workspace=scripts-data frontend-ready`);
    console.log('');
  }
  ...
  provideTroubleshootingGuidance(command, error) {
    ...
    this.printBullet('List available reset states: `npm run reset-data --workspace=scripts-data --workspace=scripts-states`');
      ...
      steps.push({
        ...
        steps: [
          ...
          { 
            ...
            command: 'npm run reset-data --workspace=scripts-data --workspace=scripts-states'
          },
          { 
            action: 'Reset to known good state', 
            command: 'npm run reset-data --workspace=scripts-data --workspace=scripts-data fresh'
          }
        ]
      });
    }
      ...
      steps.push({
        ...
        steps: [
          ...
          { 
            ...
            command: 'npm run validate --workspace=scripts/documentation-analysis --workspace=scripts/documentation-analysis-data consistency'
          },
          { 
            action: 'Validate image accessibility', 
            command: 'npm run validate --workspace=scripts/documentation-analysis --workspace=scripts/documentation-analysis-data images'
          },
          { 
      ...
      steps.push({
        ...
        steps: [
          ...
          { 
            ...
            command: 'npm run reset-data --workspace=scripts-data --workspace=scripts-data clean'
          }
        ]
      });
    }
  ...
  suggestRecoveryActions(command, category) {
    ...
    const recoveryActions = {
      ...
      data: [
        'Run `npm run reset-data --workspace=scripts-data --workspace=scripts-data fresh`',
  ...
  displayStudioE2EValidationResults(report, options) {
    ...
    if (success) {
      ...
      this.printBullet('Use `npm run validate --workspace=scripts/documentation-analysis --workspace=scripts/documentation-analysis-studios` for studio-specific validation');
