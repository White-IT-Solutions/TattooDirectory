...
docker-compose -f devtools\docker\docker-compose.local.yml down --remove-orphans >nul 2>&1
...
docker-compose -f devtools\docker\docker-compose.local.yml ps | findstr "data-seeder" >nul
if %errorlevel% equ 0 (
