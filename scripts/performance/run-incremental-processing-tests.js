...
const { IncrementalProcessingTester } = require('../testing/test-incremental-processing');
const { ForceRefreshTester } = require('../testing/test-force-refresh-mode');
...
class IncrementalProcessingTestRunner {
  ...
  setupTestEnvironment() {
    ...
    const testResultsDir = path.join(__dirname, '../../.metrics/performance');
  ...
  generateComprehensiveReport() {
    ...
    const reportPath = path.join(__dirname, '../../.metrics/performance', 'incremental-processing-comprehensive-report.json');
