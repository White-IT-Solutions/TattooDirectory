...
const { PerformanceTestRunner } = require('./frontend-sync-performance-tests');
...
class PerformanceTestOrchestrator {
  ...
  async generateComprehensiveReport() {
    const reportPath = path.join(__dirname, '../../.metrics/performance', 'performance-comprehensive-report.md');
...
`;
  ...
  async generateMemoryProfileReport(memoryResults) {
    const reportPath = path.join(__dirname, '../../.metrics/performance', 'memory-profile-report.md');
...
`;
  ...
  async generateConcurrentOperationReport(concurrentResults) {
    const reportPath = path.join(__dirname, '../../.metrics/performance', 'concurrent-operations-report.md');
...
`;
  ...
  async saveTestResults() {
    const resultsPath = path.join(__dirname, '../../.metrics/performance', `performance-test-results-${Date.now()}.json`);
