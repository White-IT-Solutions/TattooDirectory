...
class StartupOptimizer {
    ...
    async optimizeDockerCompose() {
        ...
        const composeFile = 'dev-tools/docker/docker-compose.local.yml';
...
start_service_group() {
    ...
    for service in "\${services[@]}"; do
        docker-compose -f dev-tools/docker/docker-compose.local.yml up -d $service &
    done
...
docker-compose -f dev-tools/docker/docker-compose.local.yml up -d localstack
...
docker-compose -f dev-tools/docker/docker-compose.local.yml up -d backend frontend swagger-ui
